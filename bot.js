...
bot.command('runtime', async (ctx) => {
  ...
  ctx.reply(` ᴀᴍᴢʏ xᴅ ɪs ᴏɴʟɪɴᴇ ғᴏʀ *${formatRuntime(uptime)}*`, {
    parse_mode: 'Markdown'
  });
});
bot.start((ctx) => {
...
ctx.reply('ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ sᴛᴀʀᴛ ᴛʜᴇ ᴀᴍᴢʏ ᴘʀᴏᴄᴇsᴀ', {
  reply_markup: {
    inline_keyboard: [
      [
        { text: 'sᴛᴀʀᴛ ᴀᴍᴢʏ ᴍᴅ', callback_data: 'start_bot' }
      ]
    ]
  }
});
...
bot.action('start_bot', async (ctx) => {
  ...
  const photoUrl = 'https://files.catbox.moe/u6oxd2.jpg';
  const captionText =`
╭━━━━━━━━━━━━━━━╮
│
   🤖 ʙᴏᴛ ɪɴғᴏ
...
**ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀᴍᴢʏ ᴛᴇᴄʜ**`;
    
  const buttons = Markup.inlineKeyboard([
    [
      Markup.button.url('ɢʀᴏᴜᴘ', 'https://t.me/devil_shpopp'),
      Markup.button.url('ᴄʜᴀɴɴᴇʟ', 'https://t.me/devil_shop_hack')
    ...
    if (!joinedAllChannels) {
      return ctx.reply(
        `ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴄᴏᴍᴍᴇɴᴄᴇ ʙᴏᴛ ᴘᴀɪʀɪɴɢ ᴘʀᴏᴄᴇss.`,
        {
          ...
          reply_markup: {
            inline_keyboard: [
              [{ text: 'ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ', url: 'https://t.me/devil_shop_hack' }],
              [{ text: 'ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ', url: 'https://t.me/empireTechBackup' }],
              [{ text: 'ᴊᴏɪɴ ɢʀᴏᴜᴘ', url: 'https://t.me/devil_shpopp' }],
              [{ text: 'ᴊᴏɪɴ ɢʀᴏᴜᴘ', url: 'https://t.me/number_devil' }],
...
**ᴘᴏᴡᴇʀᴇᴅ ʙʏ ☩ Void Equalizer ☩**`,
      {
        ...
        reply_markup: {
          inline_keyboard: [
            [{ text: 'ᴄʜᴀɴɴᴇʟ', url: 'https://t.me/devil_shop_hack' }]
          ]
        }
      }
    );
